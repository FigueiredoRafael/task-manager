...
// PROFILE UPDATE MESSAGES
  ...
  $wrongPwd             = ' <div class="col-3 alert alert-danger alert-dismissible fade show" role="alert">
                              A Senha está <strong>incorreta</strong>.
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>';
  $weakPwd              = ' <div class="col-2 alert alert-danger alert-dismissible fade show" role="alert">
                              A Senha está <strong>fraca</strong>.
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>';
  $pwdNotSame           = ' <div class="col-2 alert alert-danger alert-dismissible fade show" role="alert">
  ...
  $imgInvalidFormat     = ' <div class="col-3 alert alert-danger alert-dismissible fade show" role="alert">
                              Formato de imagem <strong>inválido</strong>.
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>';
  $fileTooBig           = ' <div class="col-6 alert alert-danger alert-dismissible fade show" role="alert">
                              Arquivo é muito <strong>grande</strong>. Tamanho permitido somente até <strong>1 Mb</strong>.
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>';
  $uploadImgError       = ' <div class="col-3 alert alert-danger alert-dismissible fade show" role="alert">
                              Houve um <strong>erro no Upload</strong>.
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>';
  $uploadImgSuccess     = ' <div class="col-3 alert alert-success alert-dismissible fade show" role="alert">
                              <strong>Upload de imagem</strong> feito com sucesso!
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>';
  $emptyNameFields      = ' <div class="col-3 alert alert-danger alert-dismissible fade show" role="alert">
                              <strong>Campos de Nome</strong> estão vazios!
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>';
  $emptyCelField       = ' <div class="col-3 alert alert-danger alert-dismissible fade show" role="alert">
                              <strong>Campo de Contato</strong> está vazio!
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>';
  $emptyAddressFields    = ' <div class="col-3 alert alert-danger alert-dismissible fade show" role="alert">
                              <strong>Campo de Endereço</strong> está vazio!
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>';
  $profileUpdateSuccess = '<div class="col-3 alert alert-success alert-dismissible fade show" role="alert">
