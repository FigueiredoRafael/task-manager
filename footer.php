                    ...
                    if (uid) {
                        $.ajax({
                                ...
                                success: function(data){
                                    $('#error-uid').remove();
                                    if (data == '0') {
                                        $("<span id='error-uid' style='color: red'><strong>Este usuário já está cadastrado</strong></span>").insertAfter($('#uid'));
                                        usernameError = true;
                                        errorFunction();
                                    } else {
                                        usernameError = false;
                                    ...
                                    console.log("usernameError is "+usernameError+""," and signupError is "+ signUpErrors);
                    ...
                    if (email) {
                        ...
                        $.ajax({
                                ...
                                success: function(data){
                                    $('#error-mail').remove();
                                    if (data == '0') {
                                        $("<span id='error-mail' style='color: red'><strong>Já existe um funcionário com este email</strong></span>").insertAfter($('#mail'));
                                        emailError = true;
                                        errorFunction();
                                    } else {
                                        emailError = false;
                                    ...
                                    console.log("emailError is "+emailError+""," and signupError is "+ signUpErrors);
                                    if (signUpErrors != false) {
                                        document.getElementById('signup-btn').disabled = true;
                                    } else {
                                        document.getElementById('signup-btn').disabled = false;
                    ...
                    if (cpf) {
                        ...
                        $.ajax({
                                ...
                                success: function(data){
                                    ...
                                    if (data == '0') {
                                        $("<span id='error-cpf' style='color: red'><strong>Já existe um funcionário com este CPF</strong></span>").insertAfter($('#cpf'));
                                        cpfError = true;
                                        errorFunction();
                                    } else {
                                        cpfError = false;
                                    ...
                                    console.log("cpfError is "+cpfError+""," and signupError is "+ signUpErrors);
                                    if (signUpErrors != false) {
                                        document.getElementById('signup-btn').disabled = true;
                                    } else {
                                        document.getElementById('signup-btn').disabled = false;
